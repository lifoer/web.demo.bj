...
public class GoodsController {
	...
	public String queryGoods(String word,String[] shop,String sort,@RequestParam(required = false, defaultValue = "1", value = "pageNum")int pageNum,Model model,HttpSession session) {
